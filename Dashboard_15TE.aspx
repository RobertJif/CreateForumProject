<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard_15TE.aspx.cs" Inherits="Create_Forum_Project.Dashboard_15TE" %>
...
<body style="background-image: url(Gambar/buatdiskusi2.png); background-repeat:no-repeat">
    ...
    <div class="divlogo">
     ...
     <a href="Default_15TE.aspx" style="text-decoration:none; color:White" >Beranda</a>
     &emsp;|
     &emsp;<a href="Dashboard_15TE.aspx" style="text-decoration:none; color:White">Buat Diskusi</a>
     &emsp;|
     &emsp;<a href="Home_15TE.aspx" style="text-decoration:none; color:White">Lihat Diskusi</a>
     &emsp;|
     &emsp;<a href="G15TE.aspx" style="text-decoration:none; color:White">Pilih Diskusi</a>
