...
{
    public partial class Dashboard_G14SI : System.Web.UI.Page
    {
        string user1;
        ...
        protected void BtnPost_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Insert into Forum_postg14(username, posttitle, postmessage) values ('" + user1 + "','" + txtposttitle.Text + "', '" + txtpostmessage.InnerText.ToString() + "')", con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
            Response.Redirect("~/Home_G14SI.aspx");
