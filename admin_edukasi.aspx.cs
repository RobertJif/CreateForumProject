...
{
    public partial class admin_edukasi : System.Web.UI.Page
    {
        string username;
        ...
        public void LoadPost()
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    string edukasi = ds.Tables[0].Rows[i]["edukasi"].ToString();
                    ...
                    lbljumlah.Text = "Jumlah Diskusi Edukasi: " + rows.ToString();
                }
            }
        }
