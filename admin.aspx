<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="admin.aspx.cs" Inherits="Create_Forum_Project.admin" %>
...
<body>
   ...
   <br />
    ...
    <h2>Lihat Hasil Klasifikasi</h2>
        <br />
     <asp:HyperLink ID="link" runat ="server" NavigateUrl="~/admin_edukasi.aspx">
    <asp:Image ID="img" runat="server" ImageUrl="~/Gambar/edukasi.jpg" Height="200px" Width="200px" />
       </asp:HyperLink>
       
       &emsp;&emsp;&emsp;&emsp;<asp:HyperLink ID="HyperLink1" runat ="server" NavigateUrl="~/admin_olahraga.aspx">
       <asp:Image ID="Image1" runat="server" ImageUrl="~/Gambar/olahraga.jpg" Height="200px" Width="200px" />
       </asp:HyperLink>
       
        &emsp;&emsp;&emsp;&emsp;<asp:HyperLink ID="HyperLink2" runat ="server" NavigateUrl="~/admin_politik.aspx">
       <asp:Image ID="Image2" runat="server" ImageUrl="~/Gambar/politik.jpg" Height="200px" Width="200px" />
       </asp:HyperLink>
       
        &emsp;&emsp;&emsp;&emsp;<asp:HyperLink ID="HyperLink3" runat ="server" NavigateUrl="~/admin_teknologi.aspx">
       <asp:Image ID="Image3" runat="server" ImageUrl="~/Gambar/teknologi.jpg" Height="200px" Width="200px" />
       </asp:HyperLink>
       
        &emsp;&emsp;&emsp;&emsp;<asp:HyperLink ID="HyperLink4" runat ="server" NavigateUrl="~/admin_game.aspx">
       <asp:Image ID="Image4" runat="server" ImageUrl="~/Gambar/game.jpg" Height="200px" Width="200px" />
       </asp:HyperLink> 
       <br /></center>
       <left></left>
