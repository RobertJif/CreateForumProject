<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard_14TM.aspx.cs" Inherits="Create_Forum_Project.Dashboard_14TM" %>
...
<body>
    ...
    <div class="div_logout"><a href="forumLogin.aspx">Logout</a></div>
     ...
     <table>
      ...
      <tr>
       <td><a href="Default_14TM.aspx">Beranda</a></td>
      </tr>
      <tr>
       <td><a href="Dashboard_14TM.aspx">Buat Diskusi</a></td>
      </tr>
      <tr>
       <td><a href="Home_14TM.aspx">Lihat Diskusi</a></td>
      </tr>
     </table>
    </div>
    <div id="div_table">
