...
{
    public partial class Default_14SI : System.Web.UI.Page
    {
        string username;
        ...
        public void LoadPost()
        {
            ...
            SqlDataAdapter da = new SqlDataAdapter("Select * from forum_post15si", con);
            SqlDataAdapter da2 = new SqlDataAdapter("Select * from komen_si where postid=" + s, con);
            con.Open();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    //btnReadMore.InnerHtml = "<a href=\"Comment_G15.aspx?field1="+id+"\">Komentar</a>";
                    ...
                    btnReadMore.InnerHtml = "<a href=\"Comment_14SI.aspx?field1=" + id + "\">Komentar</a>";
                    divreader.Controls.Add(btnReadMore);
