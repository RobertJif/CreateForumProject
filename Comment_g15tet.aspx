<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Comment_g15tet.aspx.cs" Inherits="Create_Forum_Project.Comment_g15tet" %>
...
<body>
    ...
    <div class="divlogo">
     ...
     <a href="Default_G15TET.aspx" style="text-decoration:none; color:White" >Beranda</a>
     &emsp;|
     &emsp;<a href="Dashboard_G15TET.aspx" style="text-decoration:none; color:White">Buat Diskusi</a>
     &emsp;|
     &emsp;<a href="Home_G15TET.aspx" style="text-decoration:none; color:White">Lihat Diskusi</a>
     &emsp;|
