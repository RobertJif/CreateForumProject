...
{
    public partial class Home_G15TI : System.Web.UI.Page
    {
        string user1;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("~/Default_G15TI.aspx");
            }
        }
        /*
        ...
        */
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("Select * from forum_postg15 where username='" + user1 + "'", con);
            con.Open();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    btnReadMore.InnerHtml = "<a href=\"Comment_g15ti.aspx?field1="+id+"\">Komentar</a>";
