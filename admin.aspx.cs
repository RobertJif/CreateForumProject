...
namespace Create_Forum_Project
{
    public partial class admin : System.Web.UI.Page
    {
        ...
        public void LoadPost()
        {
            ...
            SqlDataAdapter da3 = new SqlDataAdapter("Select * from klasifikasipolitik", con);
            SqlDataAdapter da4 = new SqlDataAdapter("Select * from klasifikasiteknologi", con);
            SqlDataAdapter da5 = new SqlDataAdapter("Select * from klasifikasi_game", con);
