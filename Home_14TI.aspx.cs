...
{
    public partial class Home_14TI : System.Web.UI.Page
    {
        string user1;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("~/Default_14TI.aspx");
            }
        }
        /*
        ...
        */
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("Select * from forum_post15ti where username='" + user1 + "'", con);
            con.Open();
