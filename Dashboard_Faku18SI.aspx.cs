...
{
    public partial class Dashboard_Faku18SI : System.Web.UI.Page
    {
        string user1;
        ...
        protected void BtnPost_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Insert into Forum_PostFaku(username, posttitle, postmessage) values ('" + user1 + "','" + txtposttitle.Text + "', '" + txtpostmessage.InnerText.ToString() + "')", con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
            Response.Redirect("~/Home_Faku18SI.aspx");
