...
{
    public partial class admin_game : System.Web.UI.Page
    {
        string username;
        ...
        {
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["FRCon"].ConnectionString);
            SqlDataAdapter da = new SqlDataAdapter("Select * from klasifikasi_game", con);
            con.Open();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    string panitia = ds.Tables[0].Rows[i]["game"].ToString();
                    ...
                    lbljumlah.Text = "Jumlah Diskusi Game: " + rows.ToString();
                }
            }
        }
