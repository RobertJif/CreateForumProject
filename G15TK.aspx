<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="G15TK.aspx.cs" Inherits="Create_Forum_Project.G15TK" %>
...
<body style="background-image: url(Gambar/web2.png)">
    ...
    <h2>Pilih Diskusi</h2><br />
     <asp:HyperLink ID="link" runat ="server" NavigateUrl="~/Default_G15TK.aspx">
    <asp:Image ID="img" runat="server" ImageUrl="~/Gambar/g15 tk.png" Height="300px" Width="300px" />
       </asp:HyperLink>
       
       &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<asp:HyperLink ID="HyperLink1" runat ="server" NavigateUrl="~/Default_15TK.aspx">
       <asp:Image ID="Image1" runat="server" ImageUrl="~/Gambar/tk.png" Height="300px" Width="300px" />
       </asp:HyperLink>
       
        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<asp:HyperLink ID="HyperLink2" runat ="server" NavigateUrl="~/Default_Umum_15TK.aspx">
       <asp:Image ID="Image2" runat="server" ImageUrl="~/Gambar/tk umu.png" Height="300px" Width="300px" />
       </asp:HyperLink> 
