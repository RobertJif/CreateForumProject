...
{
    public partial class Dashboard_14SI : System.Web.UI.Page
    {
        string user1;
        ...
        protected void BtnPost_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand cmd = new SqlCommand("Insert into forum_post15si(username, posttitle, postmessage) values ('" + user1 + "','" + txtposttitle.Text + "', '" + txtpostmessage.InnerText.ToString() + "')", con);
            con.Open();
            cmd.ExecuteNonQuery();
            con.Close();
            Response.Redirect("~/Home_14SI.aspx");
