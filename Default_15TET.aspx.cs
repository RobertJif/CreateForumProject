...
{
    public partial class Default_15TET : System.Web.UI.Page
    {
        string username;
        ...
        {
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["FRCon"].ConnectionString);
            SqlDataAdapter da = new SqlDataAdapter("Select * from forum_post15tet", con);
            con.Open();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    btnReadMore.InnerHtml = "<a href=\"Comment_TET.aspx?field1=" + id + "\">Lihat Diskusi</a>";
                    divreader.Controls.Add(btnReadMore);
