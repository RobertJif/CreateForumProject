...
{
    public partial class G15SI_KlasifikasiBisnis : System.Web.UI.Page
    {
        string username;
        ...
        {
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["FRCon"].ConnectionString);
            SqlDataAdapter da = new SqlDataAdapter("Select * from klasifikasi_bisnis", con);
            con.Open();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    string title = ds.Tables[0].Rows[i]["bisnis"].ToString();
