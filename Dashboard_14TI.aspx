<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard_14TI.aspx.cs" Inherits="Create_Forum_Project.Dashboard_14TI" %>
...
<body style="background-image: url(Gambar/buatdiskusi2.png); background-repeat:no-repeat">
    ...
    <div class="divlogo">
     ...
     <a href="Default_14TI.aspx" style="text-decoration:none; color:White" >Beranda</a>
     &emsp;|
     &emsp;<a href="Dashboard_14TI.aspx" style="text-decoration:none; color:White">Buat Diskusi</a>
     &emsp;|
     &emsp;<a href="Home_14TI.aspx" style="text-decoration:none; color:White">Lihat Diskusi</a>
     &emsp;|
