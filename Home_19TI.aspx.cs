...
{
    public partial class Home_19TI : System.Web.UI.Page
    {
        string user1;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("~/Default_19TI.aspx");
            }
        }
        /*
        ...
        public void LoadPost()
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    btnReadMore.InnerHtml = "<a href=\"Comment_19TI.aspx?field1=" + id + "\">Komentar</a>";
