<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Comment_Umum_16TM.aspx.cs" Inherits="Create_Forum_Project.Comment_Umum_16TM" %>
...
<body>
    ...
    <div class="divlogo">
     ...
     <a href="Default_Umum_16TM.aspx" style="text-decoration:none; color:White" >Beranda</a>
     &emsp;|
     &emsp;<a href="Dashboard_Umum_16TM.aspx" style="text-decoration:none; color:White">Buat Diskusi</a>
     &emsp;|
     &emsp;<a href="Home_Umum_16TM.aspx" style="text-decoration:none; color:White">Lihat Diskusi</a>
     &emsp;|
