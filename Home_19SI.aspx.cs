...
{
    public partial class Home_19SI : System.Web.UI.Page
    {
        string user1;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("~/Default_19SI.aspx");
            }
        }
        /*
        ...
        */
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("Select * from forum_postsi where username='" + user1 + "'", con);
            con.Open();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    btnReadMore.InnerHtml = "<a href=\"Comment_19SI.aspx?field1=" + id + "\">Komentar</a>";
