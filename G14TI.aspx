<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="G14TI.aspx.cs" Inherits="Create_Forum_Project.G14TI" %>
...
<body style="background-image: url(Gambar/web2.png)">
    ...
    <h2>Pilih Diskusi</h2><br />
     <asp:HyperLink ID="link" runat ="server" NavigateUrl="~/Default_G14TI.aspx">
    <asp:Image ID="img" runat="server" ImageUrl="~/Gambar/g14ti.png" Height="300px" Width="300px" />
       </asp:HyperLink>
       
       &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<asp:HyperLink ID="HyperLink1" runat ="server" NavigateUrl="~/Default_14TI.aspx">
       <asp:Image ID="Image1" runat="server" ImageUrl="~/Gambar/ti.png" Height="300px" Width="300px" />
       </asp:HyperLink>
       
        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<asp:HyperLink ID="HyperLink2" runat ="server" NavigateUrl="~/Default_Umum_14TI.aspx">
       <asp:Image ID="Image2" runat="server" ImageUrl="~/Gambar/Umum.png" Height="300px" Width="300px" />
       </asp:HyperLink> 
