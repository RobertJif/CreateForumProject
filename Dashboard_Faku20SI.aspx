<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Dashboard_Faku20SI.aspx.cs" Inherits="Create_Forum_Project.Dashboard_Faku20SI" %>
...
<body style="background-image: url(Gambar/buatdiskusi2.png); background-repeat:no-repeat">
    ...
    <div class="divlogo">
     ...
     <a href="Default_Faku20SI.aspx" style="text-decoration:none; color:White" >Beranda</a>
     &emsp;|
     &emsp;<a href="Dashboard_Faku20SI.aspx" style="text-decoration:none; color:White">Buat Diskusi</a>
     &emsp;|
     &emsp;<a href="Home_Faku20SI.aspx" style="text-decoration:none; color:White">Lihat Diskusi</a>
     &emsp;|
     &emsp;<a href="G20SI.aspx" style="text-decoration:none; color:White">Pilih Diskusi</a>
