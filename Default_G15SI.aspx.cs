...
{
    public partial class Default_G15SI : System.Web.UI.Page
    {
        string username;
        ...
        {
            SqlConnection con = new SqlConnection(ConfigurationManager.ConnectionStrings["FRCon"].ConnectionString);
            //String s = Request.QueryString["field2"];
            SqlDataAdapter da = new SqlDataAdapter("Select * from forum_postg15", con);
            con.Open();
            DataSet ds = new DataSet();
            da.Fill(ds);
           
            //lblJumlah.Text = "Jumlah Komentar:" + rows1.ToString();
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    SqlDataAdapter da2 = new SqlDataAdapter("Select * from komen_g15 where postid=" + id, con);
                    ...
                    btnReadMore.Attributes.Add("class", "btnreadmore");
                    HtmlGenericControl btnReadMore2 = new HtmlGenericControl("label");
                    HtmlGenericControl btnReadMore3 = new HtmlGenericControl("label");
                   //btnReadMore2.Attributes.Add("class", "btnreadmore");
                    //btnReadMore.InnerText = "Lihat";
                    //btnReadMore.Attributes.Add("href", "javascript:readarticles()");
                    btnReadMore.InnerHtml = "<a href=\"Comment_g15si.aspx?field1=" + id + "\">Komentar</a>";
                    divreader.Controls.Add(btnReadMore);
                    btnReadMore3.InnerHtml = "<br/> ";
                    divreader.Controls.Add(btnReadMore3);

                    btnReadMore2.InnerHtml = "Jumlah Komentar: " + rows1.ToString();
                    divreader.Controls.Add(btnReadMore2);
