<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Comment_16TM.aspx.cs" Inherits="Create_Forum_Project.Comment_16TM" %>
...
<body>
    ...
    <div class="divlogo">
     ...
     <a href="Default_16TM.aspx" style="text-decoration:none; color:White" >Beranda</a>
     &emsp;|
     &emsp;<a href="Dashboard_16TM.aspx" style="text-decoration:none; color:White">Buat Diskusi</a>
     &emsp;|
     &emsp;<a href="Home_16TM.aspx" style="text-decoration:none; color:White">Lihat Diskusi</a>
     &emsp;|
