<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="G20SI.aspx.cs" Inherits="Create_Forum_Project.G20SI" %>
...
<body style="background-image: url(Gambar/web2.png)">
    ...
    <h2>Pilih Diskusi</h2><br />
     <asp:HyperLink ID="link" runat ="server" NavigateUrl="~/Default_G20SI.aspx">
    <asp:Image ID="img" runat="server" ImageUrl="~/Gambar/20si.jpg" Height="300px" Width="300px" />
       </asp:HyperLink>
       
       &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<asp:HyperLink ID="HyperLink1" runat ="server" NavigateUrl="~/Default_20SI.aspx">
       <asp:Image ID="Image1" runat="server" ImageUrl="~/Gambar/prodisi.jpg" Height="300px" Width="300px" />
       </asp:HyperLink>
       
        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<asp:HyperLink ID="HyperLink2" runat ="server" NavigateUrl="~/Default_Faku20SI.aspx">
       <asp:Image ID="Image2" runat="server" ImageUrl="~/Gambar/faksi.jpg" Height="300px" Width="300px" />
       </asp:HyperLink> 
