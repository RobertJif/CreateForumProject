<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="G15AK.aspx.cs" Inherits="Create_Forum_Project.G15AK" %>
...
<body style="background-image: url(Gambar/web2.png)">
    ...
    <h2>Pilih Diskusi</h2><br />
     <asp:HyperLink ID="link" runat ="server" NavigateUrl="~/Default_G15AK.aspx">
    <asp:Image ID="img" runat="server" ImageUrl="~/Gambar/G15AK.png" Height="300px" Width="300px" />
       </asp:HyperLink>
       
       &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<asp:HyperLink ID="HyperLink1" runat ="server" NavigateUrl="~/Default_15AK.aspx">
       <asp:Image ID="Image1" runat="server" ImageUrl="~/Gambar/akuntansi.png" Height="300px" Width="300px" />
       </asp:HyperLink>
       
        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<asp:HyperLink ID="HyperLink2" runat ="server" NavigateUrl="~/Default_Umum_15AK.aspx">
       <asp:Image ID="Image2" runat="server" ImageUrl="~/Gambar/UmumAK.png" Height="300px" Width="300px" />
       </asp:HyperLink> 
