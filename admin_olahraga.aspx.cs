...
{
    public partial class admin_olahraga : System.Web.UI.Page
    {
        string username;
             ...
             public void LoadPost()
        {
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    string olahraga = ds.Tables[0].Rows[i]["olahraga"].ToString();
                    ...
                    h2.InnerText = olahraga.ToString();
                    /* Post Message */
                    ...
                    lbljumlah.Text="Jumlah Diskusi Olahraga: "+rows.ToString();
                }
            }
        }
