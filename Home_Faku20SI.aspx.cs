...
{
    public partial class Home_Faku20SI : System.Web.UI.Page
    {
        string user1;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("~/Default_Faku20SI.aspx");
            }
        }
        /*
        ...
        */
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("Select * from forum_PostFaku where username='" + user1 + "'", con);
            con.Open();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    btnReadMore.InnerHtml = "<a href=\"Comment_Faku20SI.aspx?field1=" + id + "\">Komentar</a>";
