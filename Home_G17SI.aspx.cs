...
{
    public partial class Home_G17SI : System.Web.UI.Page
    {
        string user1;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Redirect("~/Default_G17SI.aspx");
            }
        }
        /*
        ...
        */
        ...
        {
            SqlDataAdapter da = new SqlDataAdapter("Select * from forum_postg17 where username='" + user1 + "'", con);
            con.Open();
            ...
            if (ds.Tables[0].Rows.Count > 0)
            {
                ...
                for (int i = 0; i < ds.Tables[0].Rows.Count; i++)
                {
                    ...
                    btnReadMore.InnerHtml = "<a href=\"Comment_G17SI.aspx?field1=" + id + "\">Komentar</a>";
