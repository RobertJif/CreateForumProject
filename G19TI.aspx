<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="G19TI.aspx.cs" Inherits="Create_Forum_Project.G19TI" %>
...
<body style="background-image: url(Gambar/web2.png)">
    ...
    <h2>Pilih Diskusi</h2><br />
     <asp:HyperLink ID="link" runat ="server" NavigateUrl="~/Default_G19TI.aspx">
    <asp:Image ID="img" runat="server" ImageUrl="~/Gambar/G19 TI.jpg" Height="300px" Width="300px" />
       </asp:HyperLink>
       
       &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<asp:HyperLink ID="HyperLink1" runat ="server" NavigateUrl="~/Default_19TI.aspx">
       <asp:Image ID="Image1" runat="server" ImageUrl="~/Gambar/Prodi TI.jpg" Height="300px" Width="300px" />
       </asp:HyperLink>
       
        &emsp;&emsp;&emsp;&emsp;&emsp;&emsp;<asp:HyperLink ID="HyperLink2" runat ="server" NavigateUrl="~/Default_Faku19TI.aspx">
