<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuatDiskusi_A17TI.aspx.cs" Inherits="Create_Forum_Project.BuatDiskusi_A17TI" %>
...
<body style="background-image: url(Gambar/buatdiskusi2.png); background-repeat:no-repeat">
    ...
    <div class="divlogo">
     ...
     <a href="Beranda_A17TI.aspx" style="text-decoration:none; color:White" >Beranda</a>
     &emsp;|
     &emsp;<a href="BuatDiskusi_A17TI.aspx" style="text-decoration:none; color:White">Buat Diskusi</a>
     &emsp;|
     &emsp;<a href="Own_A17TI.aspx" style="text-decoration:none; color:White">Lihat Diskusi</a>
     &emsp;|
